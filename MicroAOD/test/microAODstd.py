...
process.source = cms.Source("PoolSource",fileNames=cms.untracked.vstring("file:/tmp/rateixei/3C2EFAB1-B16F-E411-AB34-7845C4FC39FB.root", "file:/tmp/rateixei/7440A69A-4F70-E411-93D3-00A0D1EE273C.root", "file:/tmp/rateixei/E270C596-4F70-E411-9EB9-7845C4FC347F.root"))
...
process.out = cms.OutputModule("PoolOutputModule", fileName = cms.untracked.string('myMicroAODOutputFile_mod_1p5k_vec_pers.root'),

...
process.hltHighLevelOthers = hltHighLevel.clone(HLTPaths = cms.vstring("HLT_Diphoton30PV_18PV_R9Id_AND_IsoCaloId_AND_HE_R9Id_DoublePixelVeto_Mass55_v1",
                                                                "HLT_Diphoton30EB_18EB_R9Id_OR_IsoCaloId_AND_HE_R9Id_DoublePixelVeto_Mass55_v1"
                                                                ))

process.hltHighLevelPrimary = hltHighLevel.clone(HLTPaths = cms.vstring("HLT_Diphoton30_18_R9Id_OR_IsoCaloId_AND_HE_R9Id_Mass95_v1")
                                                 )
...
process.triggersAtEnd = cms.Sequence()
if customize.processId == "Data":
#        process.dataRequirements += process.hltHighLevel
#        process.dataRequirements += process.eeBadScFilter
    process.dataRequirements = cms.Sequence(process.eeBadScFilter)
    process.triggersAtEnd = cms.Sequence(process.hltHighLevelOthers * ~process.hltHighLevelPrimary)
...
if (customize.processId.count("qcd") or customize.processId.count("gjet")) and customize.processId.count("fake"):
    ...
    if (customize.processId.count("promptfake")):
        print "FILTERING FOR PROMPT-FAKE"

...
if customize.processId.count("h_") or customize.processId.count("vbf_") or customize.processId.count("Acceptance"): # convention: ggh vbf wzh (wh zh) tth
    ...
    if customize.doHTXS and not customize.processId.count("vbf_"):
...
if (customize.processId == "th_125" or customize.processId == "bbh_125" or customize.processId.count("vbf")):

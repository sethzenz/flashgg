...
fggRunJobs.py --load DY_76x_jobs.json -d /vols/cms04/szenz/DY_76x_jobs_30 -x cmsRun VBFTagDumper_standard_zee_76x_cfg.py maxEvents=-1 -n 500 -q hepmedium.q -D -P useAAA=1 --no-use-tarball 

# could not get everything to match up in 76x, kept failing asserts in globalVariablesComputer

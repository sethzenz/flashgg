...
process.flashggVBFMVAMerge15 = process.flashggVBFMVA.clone(merge3rdJet=cms.untracked.bool(True),thirdJetDRCut = cms.untracked.double(1.5))
process.flashggVBFMVAMerge10 = process.flashggVBFMVA.clone(merge3rdJet=cms.untracked.bool(True),thirdJetDRCut = cms.untracked.double(1.0))
...
process.flashggVBFWorkflowTest = cms.EDProducer("FlashggVBFWorkflowAnalyzer",
                                                ...
                                                VBFMVAResultTagHighest = cms.InputTag('flashggVBFMVA'), # ignored
#                                             VBFDiPhoDiJetMVAResultTag=cms.InputTag('flashggVBFDiPhoDiJetMVA'),
                                                VBFMVAResultTag=cms.InputTag('flashggVBFMVAMerge15'),
...
process.p = cms.Path(process.flashggUnpackedJets
                     ...
                     * process.flashggVBFMVAMerge10
                     * process.flashggVBFMVAMerge15

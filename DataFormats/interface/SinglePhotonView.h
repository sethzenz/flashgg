...
namespace flashgg {
    ...
    public:
        ...
        const cand_type *photonPtr() const  {  return &photon(); }
        const cand_type *operator->() const {  return &photon(); }
        ...
        cand_type *photonPtr() { return &photon(); }
        cand_type *operator->() { return &photon(); }
